            ...
            <Actionsheet.Content>
              ...
              <HStack space={3} m={3}>
                <Button
                  ...
                  onPress={() =>
                    setSchedule({ day: 'every', occurrence: 'Daily' })
                  }
                >
                  Daily
                </Button>
                <Button
                  ...
                  onPress={() =>
                    setSchedule({ day: schedule.day, occurrence: 'Weekly' })
                  }
                >
                  Weekly
                </Button>
                <Button
                  ...
                  onPress={() =>
                    setSchedule({ day: schedule.day, occurrence: 'Monthly' })
                  }
                >
                  Monthly
                </Button>
                ...
                {schedule.occurrence !== 'Daily' ? (
                  ...
                  <>
                    ...
                    <Text textAlign="center" color="primary.600">
                      This frequency means that your first contribution will
                      start Today and repeat everyday after that.
                    </Text>
                  </>
                )}
              </Box>
